<div class="col-md-6">
       ...
       <h6>Interested in helping translate Twitter? Check out the <a href="#">Translation Center.</a></h6>
                      </div>
                      </div>
                      <div class="row">
                          <div class="col-md-offset-1 col-md-2">
                      ...
                      <div class="col-md-8">
                           <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">(GMT-07:00) Pacific Time (US)
       <span class="caret"></span></button>
                      </div>
                      </div>
                  </div>
